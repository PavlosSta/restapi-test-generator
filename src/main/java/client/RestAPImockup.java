...
public class RestAPImockup {
    ...
    public RestAPImockup() throws RuntimeException {
        this(null);
    }

    public RestAPImockup(String token) throws RuntimeException {
        this("localhost", 9000, token);
    }

    public RestAPImockup(String host, int port, String token) throws RuntimeException {
